...
class ItemRecommendedAdapter(private val onClick: (Manga, Int) -> Unit) :
    ...
    class ViewHolder(private val binding: ItemRecommendedBinding) : RecyclerView.ViewHolder(binding.root) {
        companion object {
...
class FruitLocalDIff: DiffUtil.ItemCallback<Manga>() {// cung cấp thông tin về cách xác định phần
