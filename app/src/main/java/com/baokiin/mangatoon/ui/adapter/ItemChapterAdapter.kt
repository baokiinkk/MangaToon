...
class ChapDIff: DiffUtil.ItemCallback<Chapter>() {// cung cấp thông tin về cách xác định phần
override fun areItemsTheSame(oldItem: Chapter, newItem: Chapter): Boolean { // cho máy biết 2 item_detail khi nào giống
    return oldItem.chapter_endpoint == newItem.chapter_endpoint // dung
}

    override fun areContentsTheSame(oldItem: Chapter, newItem: Chapter): Boolean { // cho biết item_detail khi nào cùng nội dung
